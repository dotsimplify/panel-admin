    ...
    <div className="fixed z-50 top-0 left-0 right-0 bottom-0 bg-slate-800 bg-opacity-90 overflow-hidden">
      ...
      >
        ...
        <div className="w-1/4 mx-auto ">
          <Gif image={deleteIcon} loop={false} />
        </div>
        <h3
          className={`text-center text-base mb-2 text-gray-600 font-semibold`}
        >
          Are you sure you want to delete ?
        </h3>
        <h3 className={`text-center text-xs text-gray-600 font-semibold`}>
          {props.deletePromptServerMessage}
        </h3>
...
export default DeletePromptComp;
